...
(function (window, document, $) {
  ...
  var fullEditor = new Quill('#full-container .editor1', {
    bounds: '#full-container .editor1',
    modules: {
      'formula': true,
      'syntax': true,
      'toolbar': [
  ...
  var fullEditor = new Quill('#full-container .editor2', {
    bounds: '#full-container .editor2',
    modules: {
      'formula': true,
      'syntax': true,
      'toolbar': [
