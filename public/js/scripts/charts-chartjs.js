...
$(window).on("load", function() {
    ...
    var chartData = {
       ...
       datasets: [
          {
             label: "Tutors",
             data: [1000, 2000, 10000, 20000, 2500, 20000, 23000, 8534, 9000],
             fill: false,
             borderColor: "#e91e63",
          ...
          {
             label: "Students",
             data: [5000, 7000, 15000, 2000, 5000, 60000, 13000, 5534, 7000],
             fill: false,
             borderColor: "#03a9f4",
...
var ctx2 = $("#line-chart2");
    ...
    var chartData2 = {
       ...
       datasets: [
          {
             label: "Revenue",
             data: [1000, 2000, 100, 200, 250, 20000, 2300, 8534, 9000, 2407, 1200, 300],
             fill: false,
             borderColor: "#e91e63",
             pointBorderColor: "#e91e63",
             pointBackgroundColor: "#FFF",
    ...
    var lineChart = new Chart(ctx2, config2);
           ...
           yAxes: [
              {
                 ...
                 scaleLabel: {
                    display: true,
                    labelString: "No of New Registrations"
                 }
              }
           ]
        },
     ...
     var chartData = {
        ...
        datasets: [
           {
              label: "Tutors",
              data: [10, 20, 10, 20, 25, 20, 23, 85, 90],
              fill: false,
              borderColor: "#e91e63",
              pointBorderColor: "#e91e63",
              pointBackgroundColor: "#FFF",
           ...
           {
              label: "Students",
              data: [50, 70, 15, 20, 50, 60, 13, 55, 70],
              fill: false,
              borderColor: "#03a9f4",
              pointBorderColor: "#03a9f4",
              pointBackgroundColor: "#FFF",
     ...
     // Create the chart
     var lineChart = new Chart(ctx_reg, config);
