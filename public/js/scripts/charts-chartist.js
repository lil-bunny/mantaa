...
new Chartist.Line('#ct50-chart', {
    labels: ['January', 'February', 'March', 'April', 'May'],
    series: [
      [2000,3000,2000,5000,1500,3000]
    ]
  }, {
      fullWidth: true,
      chartPadding: {
...
new Chartist.Pie('#ct900-chart', data, {
  labelInterpolationFnc: function (value) {
    return Math.round(value / data.series2.reduce(sum) * 100);
  }
});
