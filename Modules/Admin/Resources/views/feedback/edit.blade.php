                                ...
                                <div class="card-content">
                                    ...
                                    <div class="row">
                                        <div class="col s12" id="account">
                                            ...
                                            <form id="accountForm" method="post" action="{{ route('admin.update_feedback',['id'=>$feedback_data->id]) }}">
                                            @csrf    
                                            <div class="row">
                                                    <div class="col s12 m6">
                                                        <div class="row">
                                                            <div class="col s12 input-field">
                                                                <input id="user" name="user" type="text" class="validate" value="{{ $feedback_data->user->full_name }}" data-error=".errorTxt2" readonly>
                                                    ...
                                                    <div class="col s12 m6">
                                                        <div class="row">
                                                            <div class="col s12 input-field">
                                                                <input id="area" name="area" type="text" class="validate" value="{{ $feedback_data->area->title ?? '' }}" data-error=".errorTxt2" readonly>
