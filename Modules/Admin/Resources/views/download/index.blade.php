                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col s10 m6 l6">
                                <h5 class="breadcrumbs-title mt-0 mb-0"><span>Download</span></h5>
                                    ...
                                    <div class="card-content">
                                        ...
                                        <div class="responsive-table">
                                            @if($downloads->count())
                                                    ...
                                                    <tbody>
                                                        @foreach($downloads as $download)
                                                            <tr>
                                                                ...
                                                                <td>{{ $download->area->title ?? '' }} </td>
                                                                <td>{{ $download->created_at }}</td>
                                                                <td><a href="{{ route('admin.download_view', ['id' => $download->id]) }}"  title="View"><i class="material-icons">remove_red_eye</i></a>
                                                                    <a class="waves-effect waves-light modal-trigger" href="#modal{{$download->id}}"><i class="material-icons red-text">delete</i></a>    
                                                                    <form action="{{ route('admin.download_delete', ['id' => $download->id]) }}" id="download-{{$download->id}}" method="POST">
                                                                        @csrf    
                                                                        <div class="modal" id="modal{{$download->id}}" >
                                                ...
                                                <p>
                                                    Displaying {{$downloads->count()}} of {{ $downloads->total() }} downloads.
                                                </p>
                                            @else
