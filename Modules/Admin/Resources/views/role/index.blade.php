                        ...
                        <section class="users-list-wrapper section">
                            <div class="row">
                                ...
                                <div class="col s12 m6 l2 display-flex align-items-center show-btn mb-3">
                                    <a class="btn waves-effect waves-light invoice-create border-round z-depth-4" href="{{ route('admin.role_add') }}"><i class="material-icons">add</i>Add User</a>
                                </div>
                            </div>
                                        ...
                                        <form method="GET">
                                            <div class="col s12 m6 l4">
                                                ...
                                                <div class="input-field">
                                                    <input type="text" name="role_title" class="form-control" id="users-list-verified" value="{{ $filters['role_title'] }}">
                                                </div>
                                            </div>
                                            <div class="col s12 m6 l4">
                                    ...
                                    <div class="card-content">
                                        ...
                                        <div class="responsive-table">
                                            @if($roles->count())
                                                    ...
                                                    <tbody>
                                                        @foreach($roles as $role)
                                                            <tr>
                                                                ...
                                                                <td><a href="{{ route('admin.role_edit', ['id' => $role->id]) }}"  title="Edit Role"><i class="material-icons">edit</i></a>
                                                                    <a class="waves-effect waves-light modal-trigger" href="#modal{{$role->id}}"><i class="material-icons red-text">delete</i></a>    
                                                                    <form action="{{ route('admin.role_delete', ['id' => $role->id]) }}" id="role-{{$role->id}}" method="POST">
                                                                        @csrf    
                                                                        <div class="modal" id="modal{{$role->id}}" >
                                                ...
                                                <p>
                                                    Displaying {{$roles->count()}} of {{ $roles->total() }} users.
                                                </p>
                                            @else
